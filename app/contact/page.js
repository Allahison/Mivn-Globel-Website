...
export const metadata = {
  title: "Contact Us — Mivan Global Suite",
  description: "Get in touch with Mivan Global Suite. Request a free consultation for e-commerce operations, custom software development, or digital transformation.",
  keywords: ["contact Mivan Global", "free consultation", "e-commerce consultation", "software development inquiry"],
  openGraph: { title: "Contact Us — Mivan Global Suite", description: "Request a free consultation. We respond within 24 hours.", url: "https://mivn-globel-website.vercel.app/contact" },
};
