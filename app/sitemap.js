...
export default function sitemap() {
  return [
    ...
    { url: `${BASE_URL}/services/crm-automation`,                         lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/services/ai-agents-personal-assistants`,          lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: `${BASE_URL}/services/wholesale-b2b-systems`,                  lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/services/dropshipping-inventory-network`,         lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/services/websites-funnels`,                       lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: `${BASE_URL}/industries/service-businesses`,                   lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
